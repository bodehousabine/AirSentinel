      ...
      <main className="p-6 pb-24 max-w-5xl mx-auto animate-in fade-in duration-700">
        ...
        <header className="mb-10">
          <h1 className="text-4xl font-black text-[#e0f2fe] mb-2 tracking-tight flex items-center gap-3">
            Santé <span className="text-[#ef4444]">Enfants</span> <span className="text-3xl">👶</span>
          </h1>
          <p className="text-[#e0f2fe]/50 text-sm font-medium italic">Préconisations personnalisées pour les enfants selon la qualité de l'air.</p>
        </header>
        ...
        <div className="glass-card p-10 flex flex-col items-center justify-center min-h-[400px]">
          ...
          <p className="text-gray-400 text-center mb-8 max-w-md">
            Sélectionnez une ville pour obtenir les recommandations pour les enfants.
          </p>
    ...
    <main className="p-6 pb-24 max-w-5xl mx-auto animate-in fade-in duration-700">
      <header className="mb-8">
        ...
        <div className="flex items-start justify-between">
          <div>
            <h1 className="text-3xl font-black text-white mb-1">Santé Enfants</h1>
        ...
        <div className="p-6 md:p-8">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              <h3 className="text-2xl font-black text-white mb-2">{rec?.profil || "Enfant"}</h3>
        ...
        <div className="mt-8 p-6 bg-red-500/10 rounded-3xl border border-red-500/30 flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-red-300/70 text-sm leading-relaxed">
              Les enfants sont particulièrement vulnérables. En cas de difficultés respiratoires, contactez immédiatement les services de santé.
            </p>
          </div>
        </div>
      )}
