      ...
      <main className="p-6 pb-24 max-w-5xl mx-auto animate-in fade-in duration-700">
        ...
        <header className="mb-10">
          <h1 className="text-4xl font-black text-[#e0f2fe] mb-2 tracking-tight flex items-center gap-3">
            Santé <span className="text-[#ef4444]">Seniors</span> <span className="text-3xl">👴</span>
          </h1>
          <p className="text-[#e0f2fe]/50 text-sm font-medium italic">Préconisations personnalisées pour les personnes âgées selon la qualité de l'air.</p>
        </header>
        ...
        <div className="glass-card p-10 flex flex-col items-center justify-center min-h-[400px]">
          ...
          <p className="text-gray-400 text-center mb-8 max-w-md">
            Sélectionnez une ville pour obtenir les recommandations pour les personnes âgées.
          </p>
    ...
    <main className="p-6 pb-24 max-w-5xl mx-auto animate-in fade-in duration-700">
      <header className="mb-8">
        ...
        <div className="flex items-start justify-between">
          <div>
            <h1 className="text-3xl font-black text-white mb-1">Santé Seniors</h1>
        ...
        <div className="p-6 md:p-8">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              <h3 className="text-2xl font-black text-white mb-2">{rec?.profil || "Personne Âgée"}</h3>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="glass-card p-5 text-center">
          ...
          <div className="text-[10px] text-gray-500 font-black uppercase tracking-widest mb-1">Activité</div>
          <div className={`text-sm font-bold ${rec?.niveau_risque === 'FAIBLE' ? 'text-green-400' : 'text-orange-400'}`}>
        ...
        <div className="glass-card p-5 text-center">
          ...
          <div className={`text-sm font-bold ${rec?.niveau_risque === 'FAIBLE' ? 'text-green-400' : 'text-orange-400'}`}>
            {rec?.niveau_risque === 'FAIBLE' ? '✅ Possible' : '⚠️ Restreindre'}
          </div>
        </div>
        <div className="glass-card p-5 text-center">
        ...
        <div className="mt-8 p-6 bg-red-500/10 rounded-3xl border border-red-500/30 flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-red-300/70 text-sm leading-relaxed">
              Les personnes âgées sont plus vulnérables. En cas de gêne respiratoire, contactez immédiatement un médecin.
            </p>
          </div>
        </div>
      )}
      ...
      <div className="mt-16 p-10 glass-card border-white/5 flex flex-col items-center gap-8 relative overflow-hidden group">
        ...
        <div className="flex flex-wrap justify-center gap-6 w-full">
          {[
            ...
            { title: "Asthmatiques", icon: "🫁", color: "from-red-500/20 to-red-600/5", border: "border-red-500/30", text: "text-red-400", href: "/dashboard/sante/asmatiques" }
          ].map((profile) => (
            <button
              key={profile.title}
