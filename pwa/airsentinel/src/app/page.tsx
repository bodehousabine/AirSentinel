  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", gap: "20px", alignItems: "center" }}>
        <a href="#pilliers" style={{ color: "rgba(224,242,254,0.7)", fontSize: "14px", textDecoration: "none" }}>
          Fonctionnalités
        </a>
        <a href="#techstack" style={{ color: "rgba(224,242,254,0.7)", fontSize: "14px", textDecoration: "none" }}>
          Tech
        </a>
...
export default function LandingPage() {
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: "16px", justifyContent: "center", flexWrap: "wrap" }}>
          <Link href="/dashboard" className="btn-primary">
            🗺️ &nbsp;Explorez la Carte en Temps Réel
          </Link>
          <a
            href="#pilliers"
            style={{
      ...
      >
        IndabaX Cameroon 2026 · DPA Green Tech · ISSEA · ENSP Yaoundé ·{" "}
